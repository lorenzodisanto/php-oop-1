...
// creazione istanze
$first_product = new Production("","Inglese", 9, new Genre("Azione","Bruce Wayne deve salvare Gotham City da Joker, un ex teppista che ha cambiato connotati dopo essere caduto in una vasca di acido."));
